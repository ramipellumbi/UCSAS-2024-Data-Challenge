/**
 * Given an array of strings, compute and return all possible combinations of length k.
 */
export class Combinations {
  private _combinations: string[][];

  constructor(private readonly _array: string[], private readonly _k: number) {
    this._combinations = [];
  }
